...
async function main() {
  ...
  console.log(
    `ingest ${summary.day}: ${summary.written} written, ${summary.skipped} skipped (already ingested today), ${summary.failed.length} failed of ${summary.total} approved submissions`,
  );
